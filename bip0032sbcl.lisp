...
(defun bip0032sbcl-top ()
  (sb-sys:enable-interrupt sb-unix:sigint #'(lambda (&rest args) (sb-ext:quit :unix-status 1))) ; disallow breaks
  (handler-case
   (bip0032sbcl-sub-top)
   (error (x)
...
(defun bip0032sbcl-sub-top ()
  (if (> (length sb-ext:*posix-argv*) 1)
	...
	(cond ((or (equal com "btcaddrs") (equal com "ltcaddrs") (equal com "ftcaddrs"))
		 ...
		 (progn
		   (format t "bip0032sbclexec ~d <xpubkeybase58> <ypubkeybase58> <chaincodebase58> <startindex> <numaddresses>~%" com)
	      ...
	      ((equal com "ckdpriv")
		   ...
		   (let ((priv (frombase58 (nth 2 sb-ext:*posix-argv*)))
			...
			(format t "INVALID~%"))
		      (sb-ext:quit :unix-status 0)))
		 (progn
		   (format t "bip0032sbclexec ckdpriv <privkeybase58> <chaincodebase58> <child>~%")
		   (sb-ext:quit :unix-status 1))))
	      ((equal com "ckd")
	       (if (= (length sb-ext:*posix-argv*) 5)
		   (let ((priv (frombase58 (nth 2 sb-ext:*posix-argv*)))
			...
			(format t "INVALID~%"))
		      (sb-ext:quit :unix-status 0)))
		 (progn
		   (format t "bip0032sbclexec ckd <privkeybase58> <chaincodebase58> <child>~%")
		   (sb-ext:quit :unix-status 1))))
	      ((equal com "ckdpub")
	       (if (= (length sb-ext:*posix-argv*) 6)
		   (let ((xpub (frombase58 (nth 2 sb-ext:*posix-argv*)))
			...
			(format t "INVALID~%"))
		      (sb-ext:quit :unix-status 0)))
		 (progn
		   (format t "bip0032sbclexec ckdpub <xpubkeybase58> <ypubkeybase58> <chaincodebase58> <child>~%")
		   (sb-ext:quit :unix-status 1)))
	       )
	      ((equal com "help")
	       (bip0032sbcl-help)
	      ...
	      (t
	       (format t "Unknown command ~d~%" com)
	       (sb-ext:quit :unix-status 1))))
    (progn
      (bip0032sbcl-help)
      (sb-ext:quit :unix-status 0))))
...
(defun bip0032sbcl-help ()
  (format t "bip0032sbcl help~%")
  (format t "bip0032sbcl pubkey <privkeybase58>~%")
  (format t "bip0032sbcl btcaddrs <xpubkeybase58> <ypubkeybase58> <chaincodebase58> <startindex> <numaddresses>~%")
  (format t "bip0032sbcl ltcaddrs <xpubkeybase58> <ypubkeybase58> <chaincodebase58> <startindex> <numaddresses>~%")
  (format t "bip0032sbcl ftcaddrs <xpubkeybase58> <ypubkeybase58> <chaincodebase58> <startindex> <numaddresses>~%")
  )
